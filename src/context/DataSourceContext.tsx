...
import { buildEtfProductCatalog, type EtfProductRecord } from "../lib/etfProducts";
...
type PublicCsvLoadResult =
 | { status: "ok"; bundle: AppDataBundle; indexCsvError: string | null; etfProductsCsv: string | null }
 | { status: "missing" }
 | { status: "error"; message: string };

type ApiDataLoadResult =
 | { status: "ok"; bundle: AppDataBundle; indexCsvError: string | null; etfProductsCsv: string | null; label: string }
 | { status: "missing" }
 | { status: "error"; message: string };
...
async function tryFetchPublicCsv(): Promise<PublicCsvLoadResult> {
 ...
 return { status: "ok" as const, bundle: full, indexCsvError, etfProductsCsv: ep };
 } catch (e) {
